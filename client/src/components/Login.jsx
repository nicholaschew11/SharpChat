...
const Login = () => {
  ...
  return (
    <VStack as="form" w={{base: "90%", md: "400px"}} m="auto" justify="center" h="80vh" spacing="1rem" onSubmit={formik.handleSubmit}>
        ...
        <Button colorScheme="teal" type="submit" rightIcon={<ArrowForwardIcon />} variant="outline">LOG IN</Button>
        <Button colorScheme="orange" onClick={() => navigate("/register")} variant="outline">CREATE ACCOUNT</Button>
    </VStack>
  )
}
